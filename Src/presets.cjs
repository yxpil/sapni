...
const PRESETS = [
  ...
  {
    id: "baidu",
    name: "百度千帆 (Baidu ERNIE)",
    baseURL: "https://qianfan.baidubce.com/v2",
    models: [
      { id: "ernie-5.0", desc: "ERNIE 5.0 (旗舰)" },
      { id: "ernie-4.5", desc: "ERNIE 4.5" },
      { id: "ernie-4.0-turbo-8k", desc: "ERNIE 4.0 Turbo" },
      { id: "ernie-speed-8k", desc: "ERNIE Speed (快速)" },
      { id: "ernie-lite-8k", desc: "ERNIE Lite (轻量)" },
      { id: "ernie-3.5-8k", desc: "ERNIE 3.5" },
    ],
    defaultModel: "ernie-5.0",
    temperature: 0.7,
    topP: 0.9,
    contextWindow: 131072,
    note: "国内可用, 百度自家模型, OpenAI 兼容接口",
  },
  {
    id: "siliconflow",
